<table border="1">
    <tr>
        ...
        <th>Respon LLM</th>
        <th>
            <a href="{{ route('super_admin.deteksi-ai.create') }}">Tambah Data</a>
        </th>
    </tr>
    ...
    <tr>
        ...
        <td>
            <form action="{{ route('super_admin.deteksi-ai.destroy', $v->id) }}" method="POST">
                {{ csrf_field() }}
                @method('DELETE')

                 <a href="{{ route('super_admin.deteksi-ai.show', $v->id) }}">Detail</a>
                <a href="{{ route('super_admin.deteksi-ai.edit', $v->id) }}">Edit</a>
